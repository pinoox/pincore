 ...
 * @method static GregorianDate gregorian(mixed $time = null, DateTimeZone|string|null $tz = null)
 * @method static CalendarDateInterface make(mixed $time = null, ?string $calendar = null, DateTimeZone|string|null $tz = null)
 ...
 * @method static string smart(mixed $time = null, ?string $format = null, ?string $calendar = null)
 * @method static string display(mixed $time = null, string $key = 'datetime', ?string $calendar = null)
 ...
 *
 * App calendar/timezone: set in app.php as `'date' => 'jalali'` or `'date' => ['calendar' => 'jalali']`.
 *
 * @see \Pinoox\Component\Date\DateManager
 * @see \Pinoox\Component\Date\AppDateConfig
 */
