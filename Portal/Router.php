 ...
 * @method static Collection collection(string $path = '', \Pinoox\Component\Router\Router|array|callable|null|string $routes = NULL, mixed $controller = NULL, array|string $methods = [], \Closure|array|string $action = '', array $defaults = [], array $filters = [], string $prefixName = '', array $data = [], array $flows = [], array $tags = [], ?string $context = NULL)
 ...
 * @method static ObjectPortal2 get(array|string $path, \Closure|array|string $action = '', string $name = '', array $defaults = [], array $filters = [], ?int $property = NULL, array $data = [], array $flows = [], array $tags = [])
 * @method static ObjectPortal2 post(array|string $path, \Closure|array|string $action = '', string $name = '', array $defaults = [], array $filters = [], ?int $property = NULL, array $data = [], array $flows = [], array $tags = [])
 * @method static ObjectPortal2 put(array|string $path, \Closure|array|string $action = '', string $name = '', array $defaults = [], array $filters = [], ?int $property = NULL, array $data = [], array $flows = [], array $tags = [])
 * @method static ObjectPortal2 patch(array|string $path, \Closure|array|string $action = '', string $name = '', array $defaults = [], array $filters = [], ?int $property = NULL, array $data = [], array $flows = [], array $tags = [])
 * @method static ObjectPortal2 delete(array|string $path, \Closure|array|string $action = '', string $name = '', array $defaults = [], array $filters = [], ?int $property = NULL, array $data = [], array $flows = [], array $tags = [])
 * @method static ObjectPortal2 options(array|string $path, \Closure|array|string $action = '', string $name = '', array $defaults = [], array $filters = [], ?int $property = NULL, array $data = [], array $flows = [], array $tags = [])
 * @method static ObjectPortal2 head(array|string $path, \Closure|array|string $action = '', string $name = '', array $defaults = [], array $filters = [], ?int $property = NULL, array $data = [], array $flows = [], array $tags = [])
 * @method static ObjectPortal2 purge(array|string $path, \Closure|array|string $action = '', string $name = '', array $defaults = [], array $filters = [], ?int $property = NULL, array $data = [], array $flows = [], array $tags = [])
 * @method static ObjectPortal2 trace(array|string $path, \Closure|array|string $action = '', string $name = '', array $defaults = [], array $filters = [], ?int $property = NULL, array $data = [], array $flows = [], array $tags = [])
 * @method static ObjectPortal2 connect(array|string $path, \Closure|array|string $action = '', string $name = '', array $defaults = [], array $filters = [], ?int $property = NULL, array $data = [], array $flows = [], array $tags = [])
