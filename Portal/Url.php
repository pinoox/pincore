 ...
 * @method static string|null file(int|string|\Pinoox\Model\FileModel|null $file)
 * @method static string|null fileThumb(int|string|\Pinoox\Model\FileModel|null $file)
 * @method static string|null temporaryFile(int|string|\Pinoox\Model\FileModel|null $file, \DateTimeInterface|\DateInterval|int $expiration, bool $thumb = false)
