...
class PortalContextResolverTest extends TestCase
{
    ...
    public function test_remembers_portal_call_site_from_user_file(): void
    {
        ...
        PortalCallSite::capture(
            ...
            ['index'],
            [
                ['file' => testCoreRoot() . '/Component/Source/Portal.php', 'line' => 304, 'function' => '__callStatic'],
    ...
    public function test_infers_origin_from_trace_when_call_site_missing(): void
    {
        ...
        $trace = [
            ['file' => testCoreRoot() . '/Component/Source/Portal.php', 'line' => 225, 'function' => 'callMethod', 'class' => \Pinoox\Component\Source\Portal::class, 'type' => '::', 'args' => ['render3', ['page']]],
            ['file' => testCoreRoot() . '/Component/Source/Portal.php', 'line' => 304, 'function' => '__callStatic', 'class' => \Pinoox\Portal\View::class, 'type' => '::', 'args' => ['render3', ['page']]],
