...
it('records action source from route file instead of portal proxy', function () {
    ...
    $root = str_replace('\\', '/', testProjectRoot());
    ...
    RouteSourceRegistry::rememberAction(
        ...
        [
            ...
            ['file' => testCoreRoot() . '/functions/router.php', 'line' => 57, 'function' => 'Pinoox\\Router\\action'],
            ['file' => testCoreRoot() . '/Component/Source/Portal.php', 'line' => 227, 'function' => 'callMethod'],
        ],
    );
