...
Framework tests live under `pincore/tests/` (Feature + Unit). App tests remain in `apps/{package}/tests/`.
...
3. Use `com_test_*` packages and `pincore/tests/Fixtures/sandbox/` for any disk writes.
