...
(function () {
  ...
  root.innerHTML = `
    <div data-pinx-panel style="display:none;position:relative;width:min(292px,calc(100vw - 24px));margin-bottom:10px;border:1px solid rgba(216,180,254,.24);border-radius:20px;background:linear-gradient(145deg,rgba(17,24,39,.58),rgba(76,29,149,.30) 48%,rgba(2,6,23,.62));color:#eef2ff;box-shadow:0 20px 70px rgba(15,23,42,.34),inset 0 1px 0 rgba(255,255,255,.20);backdrop-filter:blur(22px) saturate(1.35);-webkit-backdrop-filter:blur(22px) saturate(1.35);overflow:hidden">
      <div style="position:absolute;inset:0;pointer-events:none;background:radial-gradient(circle at 18% 0%,rgba(255,255,255,.22),transparent 32%),radial-gradient(circle at 88% 12%,rgba(168,85,247,.24),transparent 28%)"></div>
      <div style="position:relative;display:flex;align-items:center;justify-content:space-between;padding:12px 13px;border-bottom:1px solid rgba(255,255,255,.10)">
        <div style="display:flex;align-items:center;gap:9px;min-width:0">
          <div style="display:grid;place-items:center;width:34px;height:34px;border-radius:14px;background:linear-gradient(145deg,rgba(255,255,255,.20),rgba(139,92,246,.20));border:1px solid rgba(255,255,255,.18);box-shadow:inset 0 1px 0 rgba(255,255,255,.22),0 0 24px rgba(167,139,250,.26)">
      ...
      <div style="position:relative;display:grid;grid-template-columns:1fr 1fr;gap:7px;padding:10px">
        <a href="{$route}" target="_blank" rel="noreferrer" style="grid-column:1/-1;color:#fff;background:linear-gradient(135deg,rgba(124,58,237,.96),rgba(168,85,247,.90));text-decoration:none;border-radius:13px;padding:9px 11px;font-size:12px;font-weight:900;box-shadow:0 12px 26px rgba(124,58,237,.22),inset 0 1px 0 rgba(255,255,255,.18)">Open Inspector</a>
        <a href="{$route}#database" target="_blank" rel="noreferrer" style="color:#e5e7eb;background:rgba(255,255,255,.075);border:1px solid rgba(255,255,255,.08);text-decoration:none;border-radius:12px;padding:8px 9px;font-size:12px;font-weight:800">Database</a>
        <a href="{$route}#health" target="_blank" rel="noreferrer" style="color:#e5e7eb;background:rgba(255,255,255,.075);border:1px solid rgba(255,255,255,.08);text-decoration:none;border-radius:12px;padding:8px 9px;font-size:12px;font-weight:800">Health</a>
        <a href="{$route}#migrations" target="_blank" rel="noreferrer" style="color:#e5e7eb;background:rgba(255,255,255,.075);border:1px solid rgba(255,255,255,.08);text-decoration:none;border-radius:12px;padding:8px 9px;font-size:12px;font-weight:800">Migrate</a>
        <a href="{$route}#logs" target="_blank" rel="noreferrer" style="color:#e5e7eb;background:rgba(255,255,255,.075);border:1px solid rgba(255,255,255,.08);text-decoration:none;border-radius:12px;padding:8px 9px;font-size:12px;font-weight:800">Logs</a>
      </div>
      <div style="position:relative;border-top:1px solid rgba(255,255,255,.08);display:grid;grid-template-columns:1fr 1fr 1fr;gap:1px;background:rgba(255,255,255,.06)">
        <div style="background:rgba(15,23,42,.34);padding:8px 9px"><div style="font-size:10px;color:#cbd5e1">Tables</div><strong data-pinx-tables style="font-size:12px">--</strong></div>
        <div style="background:rgba(15,23,42,.34);padding:8px 9px"><div style="font-size:10px;color:#cbd5e1">Rows</div><strong data-pinx-rows style="font-size:12px">--</strong></div>
        <div style="background:rgba(15,23,42,.34);padding:8px 9px;min-width:0"><div style="font-size:10px;color:#cbd5e1">Engine</div><strong data-pinx-engine style="display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px">--</strong></div>
      </div>
    </div>
    <button data-pinx-toggle type="button" title="Pinx Inspector" style="height:50px;width:50px;border:1px solid rgba(221,214,254,.34);border-radius:18px;background:linear-gradient(145deg,rgba(255,255,255,.18),rgba(124,58,237,.42) 46%,rgba(15,23,42,.50));color:#fff;display:grid;place-items:center;padding:0;box-shadow:0 18px 46px rgba(88,28,135,.34),inset 0 1px 0 rgba(255,255,255,.30);backdrop-filter:blur(16px) saturate(1.4);-webkit-backdrop-filter:blur(16px) saturate(1.4);cursor:pointer">
