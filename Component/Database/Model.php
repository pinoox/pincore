 ...
 * @method static \Illuminate\Database\Eloquent\Model|\Illuminate\Database\Eloquent\Collection|\Illuminate\Database\Eloquent\Builder[]|\Illuminate\Database\Eloquent\Builder|null find($id, $columns = ['*'])
 * @method static ObjectPortal2 findMany($ids, $columns = ['*'])
 * @method static \Illuminate\Database\Eloquent\Model|\Illuminate\Database\Eloquent\Collection|\Illuminate\Database\Eloquent\Builder|\Illuminate\Database\Eloquent\Builder[] findOrFail($id, $columns = ['*'])
 * @method static \Illuminate\Database\Eloquent\Model|\Illuminate\Database\Eloquent\Builder findOrNew($id, $columns = ['*'])
 ...
 * @method static \Illuminate\Database\Eloquent\Model|\Illuminate\Database\Eloquent\Builder firstOrFail($columns = ['*'])
 * @method static \Illuminate\Database\Eloquent\Model|\Illuminate\Database\Eloquent\Builder|mixed firstOr($columns = ['*'], ?Closure $callback = NULL)
 * @method static ObjectPortal3 sole($columns = ['*'])
 * @method static mixed value($column)
 * @method static mixed valueOrFail($column)
 * @method static \Illuminate\Database\Eloquent\Collection|\Illuminate\Database\Eloquent\Builder[] get($columns = ['*'])
 * @method static \Illuminate\Database\Eloquent\Model[]|\Illuminate\Database\Eloquent\Builder[] getModels($columns = ['*'])
 ...
 * @method static ObjectPortal7 paginate($perPage = NULL, $columns = ['*'], $pageName = 'page', $page = NULL)
 * @method static ObjectPortal8 simplePaginate($perPage = NULL, $columns = ['*'], $pageName = 'page', $page = NULL)
 * @method static ObjectPortal9 cursorPaginate($perPage = NULL, $columns = ['*'], $cursorName = 'cursor', $cursor = NULL)
 ...
 * @method static \Illuminate\Database\Eloquent\Model|object|\Illuminate\Database\Eloquent\Builder|null first($columns = ['*'])
 * @method static \Illuminate\Database\Eloquent\Model|object|\Illuminate\Database\Eloquent\Builder|null baseSole($columns = ['*'])
