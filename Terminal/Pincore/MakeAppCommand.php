...
PHP;
        ...
        $copyrightStub = file_get_contents(ApplicationPaths::pincorePath() . 'stubs/copyright.stub');
...
PHP;
        ...
        $indexStub = file_get_contents(ApplicationPaths::pincorePath() . 'stubs/index.twig.stub');
        ...
        $pinooxStub = file_get_contents(ApplicationPaths::pincorePath() . 'stubs/pinoox.twig.stub');
        FileSystem::dumpFile("{$appDir}/theme/default/pinoox.twig", $pinooxStub);

        // Generate functions.php from stub
        $functionsStub = file_get_contents(ApplicationPaths::pincorePath() . 'stubs/functions.php.stub');
